...
class ReplicationManagerTransmissionData : public DeliveryNotificationManager::TransmissionData
{
public:
	...
	{
	public:
		ReplicationTransmission( int inNetworkId, EReplicatedObjectAction inAction, uint32_t inState ) :
	...
	void AddTransmission( int inNetworkId, EReplicatedObjectAction inAction, uint32_t inState );
